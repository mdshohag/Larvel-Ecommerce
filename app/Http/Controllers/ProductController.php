...
class ProductController extends Controller
{
    ...
    public function display(Request $request)
    {
        ...
        return view("vendors.admin.products.index", $title)->with('results', $results)->with('categories_id', $categories_id)->with('product', $product);
    ...
    public function add(Request $request)
    {
        ...
        // $result['commonContent'] = $this->Setting->commonContent();
        return view("vendors.admin.products.add", $title)->with('result', $result)->with('allimage', $allimage);
...
//        $result['commonContent'] = $this->Setting->commonContent();
        return view("vendors.admin.products.edit", $title)->with('result', $result)->with('allimage', $allimage);
    ...
    public function update(Request $request)
    {
        ...
        if ($request->products_type == 1) {
            return redirect('admin/vendor/products/display/' . $products_id);
        } else {
            return redirect('admin/vendor/products/images/display/' . $products_id);
        }
    }
    ...
    public function insert(Request $request)
    {
        ...
        if ($request->products_type == 1) {
            return redirect('admin/vendor/products/attach/attribute/display/' . $products_id);
        } else {
            return redirect('admin/vendor/products/images/display/' . $products_id);
        }
    }
...
//        $result['commonContent'] = $this->Setting->commonContent();
        return view("vendors.admin.products.inventory.add", $title)->with('result', $result);
...
//        $result['commonContent'] = $this->Setting->commonContent();
        return view("vendors.admin.products.inventory.attribute_div")->with('result', $result);
...
//        $result['commonContent'] = $this->Setting->commonContent();
        return view("vendors.admin.products.inventory.add1", $title)->with('result', $result);
...
//        $result['commonContent'] = $this->Setting->commonContent();
        return view("vendors.admin.products/images/index", $title)->with('result', $result)->with('products_id', $products_id);
...
//        $result['commonContent'] = $this->Setting->commonContent();
        return view('vendors.admin.products.images.add', $title)->with('result', $result)->with('products_id', $products_id)->with('allimage', $allimage);
...
//        $result['commonContent'] = $this->Setting->commonContent();
        return view("vendors/admin/products/images/edit")->with('products_images', $products_images)->with('allimage', $allimage);
...
//        $result['commonContent'] = $this->Setting->commonContent();
        return view("vendors/admin/products/images/modal/delete")->with('result', $result);
...
//        $result['commonContent'] = $this->Setting->commonContent();
        return view("vendors.admin.products.attribute.add", $title)->with('result', $result);
    }
...
//        $result['commonContent'] = $this->Setting->commonContent();
        return view("vendors/admin/products/pop_up_forms/editdefaultattributeform")->with('result', $result);
    }
...
//        $result['commonContent'] = $this->Setting->commonContent();
        return view("vendors/admin/products/modals/deletedefaultattributemodal")->with('result', $result);
...
//        $result['commonContent'] = $this->Setting->commonContent();
        return view("vendors/admin/products/pop_up_forms/editproductattributeoptionform")->with('result', $result);
    ...
    public function showdeletemodal(Request $request)
    {
        ...
        $result['data'] = array('products_id' => $products_id, 'products_attributes_id' => $products_attributes_id);
//        $result['commonContent'] = $this->Setting->commonContent();
        return view("vendors/admin/products/modals/deleteproductattributemodal")->with('result', $result);
