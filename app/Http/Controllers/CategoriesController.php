...
class CategoriesController extends Controller
{
  ...
  public function display(){
    ...
    return view("vendors.admin.category.index",$title)->with('categories', $categories);
  }
  ...
  public function add(Request $request){
    ...
    // $result['commonContent'] = $this->Setting->commonContent();
    return view("vendors.admin.category.add",$title)->with('result', $result)->with('allimage', $allimage);
  }
