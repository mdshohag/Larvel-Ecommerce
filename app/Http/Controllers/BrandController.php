...
class BrandController extends Controller
{
    ...
    public function display()
    {
        ...
        return view("vendors.admin.brand.index")->with('manufacturers', $manufacturers);
    }
    ...
    public function add(Request $request)
    {
        ...
        // $result['commonContent'] = $this->Setting->commonContent();
        return view("vendors.admin.brand.add", $title)->with('allimage', $allimage);
    }
    ...
    public function edit(Request $request)
    {
        ...
        $allimage = $this->images->getimages();        
        // $result['commonContent'] = $this->Setting->commonContent();
        return view("vendors.admin.brand.edit", $title)->with('editManufacturer', $editManufacturer)->with('allimage', $allimage);
    }
