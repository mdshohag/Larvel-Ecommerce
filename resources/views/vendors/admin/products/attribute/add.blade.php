    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ URL::to('admin/vendor/products/display') }}">{{ trans('labels.ListingAllProducts') }}</a></li>
                                    ...
                                    <div class="modal fade" id="adddefaultattributesmodal" tabindex="-1" role="dialog" aria-labelledby="addAttributeModalLabel">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                {!! Form::open(array('url' =>'vendors/admin/products/attach/attribute/default', 'name'=>'addattributefrom', 'id'=>'adddefaultattributefrom', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                                    ...
                                    <div class="modal fade" id="addAttributeModal" tabindex="-1" role="dialog" aria-labelledby="addAttributeModalLabel">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                {!! Form::open(array('url' =>'vendors/admin/products/attach/attribute/default/options/add', 'name'=>'addattributefrom', 'id'=>'addattributefrom', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
                                                {!! Form::hidden('products_id',  $result['data']['products_id'], array('class'=>'form-control', 'id'=>'products_id')) !!}
                            ...
                            <div class="box-footer text-center">
                                <a href="{{ URL::to("vendors/admin/products/display")}}" class="btn btn-default pull-left"><i class="fa fa-angle-left"></i> {{ trans('labels.back') }} </a>
                                <a href="{{ URL::to("vendors/admin/products/images/display/{$result['data']['products_id']}")}}" class="btn btn-primary pull-right"> {{ trans('labels.Save_And_Continue') }} <i class="fa fa-angle-right"></i></a>
                            </div>
