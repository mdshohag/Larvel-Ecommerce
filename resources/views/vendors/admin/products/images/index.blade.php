    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ URL::to('admin/vendor/products/display') }}"><i class="fa fa-database"></i>{{ trans('labels.ListingAllProductsImages') }}</a></li>
                    ...
                    <div class="box">
                      <div class="box-header">
                          ...
                          <div class="box-tools pull-right">
                              <a type="button" class="btn btn-block btn-primary" href="{{url('admin/vendor/products/images/add/')}}/{{$products_id}}">
                        ...
                        <div class="box-body">
                                            ...
                                            <div class="col-xs-4 col-md-2 margin-bottomset" >
                                                <div class="thumbnail">
                                                    <div class="caption">
                                                      ...
                                                      <a class="badge bg-light-blue editProductImagesModal"  href="{{url('admin/vendor/products/images/editproductimage/')}}/{{$products_image->id}}" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                            ...
                            <div class="box-footer text-center">
                                <a href="{{ URL::to("admin/vendor/products/display")}}" class="btn btn-default">{{ trans('labels.Save_And_complete') }}</a>
                            </div>
                        </div>
                        <!-- /.box-body -->
                    </div>
