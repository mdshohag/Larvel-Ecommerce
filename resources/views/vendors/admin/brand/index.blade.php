                    ...
                    <div class="box">
                        <div class="box-header">
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-lg-6 form-inline">
                                                <form name='filter' id="registration" class="filter  " method="get" action="{{url('admin/vendor/brands/filter')}}">
                                                    ...
                                                    <div class="input-group-form search-panel ">
                                                      ...
                                                      @if(isset($param,$name))  <a class="btn btn-danger " href="{{URL::to('admin/vendor/brands/display')}}"><i class="fa fa-ban" aria-hidden="true"></i> </a>@endif
                                                    </div>
                                                </form>
                            ...
                            <div class="box-tools pull-right">
                                <a href="{{ URL::to('admin/vendor/brands/add') }}" type="button" class="btn btn-block btn-primary">{{ trans('labels.AddNew') }}</a>
                            </div>
                        </div>
                                        ...
                                        @if(count($manufacturers)>0)
                                            @foreach ($manufacturers  as $key=>$manufacturer)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a data-toggle="tooltip" data-placement="bottom" title="Edit" href="{{ URL::to('admin/vendor/brands/edit/'.$manufacturer->id)}}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                                        <a id="manufacturerFrom" manufacturers_id='{{ $manufacturer->id }}' data-toggle="tooltip" data-placement="bottom" title="Delete" data-href="{{url('admin/vendor/brands/delete')}}" class="badge bg-red"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                                </tr>
                                            @endforeach
            ...
            <div class="modal fade" id="manufacturerModal" tabindex="-1" role="dialog" aria-labelledby="deleteManufacturerModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        {!! Form::open(array('url' =>'admin/vendor/brands/delete', 'name'=>'deleteManufacturer', 'id'=>'deleteManufacturer', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
