                                        ...
                                        @if(count($categories)>0)
                                            ...
                                            @foreach ($categories as $key=>$category)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a data-toggle="tooltip" data-placement="bottom" title="Edit" href="{{url('admin/vendor/categories/edit/'. $category->id) }}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
